...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "3odoscRSyBY1NO2rVakV0ZN1h", consumerSecret: "rY9EfZVbXLMm0XadLVwat0nfihbSxLR5LVw4smcVeSinjvkqTI")
    var loginSuccess: (() -> ())?
